...
class ServerCertRenewAction extends Action implements ShouldQueue
{
     ...
     * @var string
     */
    public $confirmButtonText = 'Renew Certificates';
     ...
     * @var string
     */
    public $confirmText = 'Are you sure you want to renew certificates?';
